...
function initI18n() {
    var i18n = new I18nAdapter([ 'nl', 'nl' ], 'nl');
    i18n.setLocale('nl', [ 'i18n/resources-locale_nl-NL.js', 'i18n/en-us/messages2.json' ]).then(initAngular);
