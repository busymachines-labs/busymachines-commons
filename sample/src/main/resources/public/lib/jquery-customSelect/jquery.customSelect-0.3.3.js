        ...
        customSelect: function (options) {
            ...
            return this.each(function () {
                var $select = $(this),
                    ...
                    iconElement = $('<span class="customSelectIcon"></span>');
                ...
                if (options.iconElement) {
                    if (options.iconElementClass) {
                        iconElement.addClass(options.iconElementClass);
                    }
                    if (options.iconElementPosition === 'after') {
                        customSelectSpan.append(iconElement);
                    } else if (options.iconElementPosition === 'before') {
                        customSelectSpan.prepend(iconElement);
                    } else {
                        customSelectSpan.append(iconElement);
                    }
                }
