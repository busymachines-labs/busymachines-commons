mdm.factory("AssetModels", ["$resource", "$rootScope", function($resource, $rootScope) {
    return $resource(
...
mdm.factory('AuthService', ["$rootScope", "$injector", function($rootScope, $injector) {
...
mdm.factory("AuthResponseInterceptor", ["$q", "$rootScope", "AuthService", function($q, $rootScope, AuthService) {
...
mdm.factory("SpinnerInterceptor", ["$q", "RequestCounter", function($q, RequestCounter) {
    function success(response) {
...
mdm.factory("RequestCounter", ["$rootScope", function($rootScope) {
