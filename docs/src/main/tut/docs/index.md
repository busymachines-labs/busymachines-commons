...
```scala
val bmCommonsVersion: String = "0.3.0-RC9"
...
These modules have been removed starting with version `0.3.0-RC9`. In case any bugs are found, they will be fixed and released as version `0.2.x`. Think parallel scala `2.11`, and `2.12` series.
